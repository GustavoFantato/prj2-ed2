...
-> Antes de terminar a execucao da funcionalidade, deve usar binarioNaTela()
 ...
 | m: quantidade de vezes que o par nomeCampoB e valorCampoB pode repetir na busca pelos registros a serem atualizados.
 | p: quantidade de vezes que o par nomeCampoA e valorCampoA pode repetir para a atualizacao.
